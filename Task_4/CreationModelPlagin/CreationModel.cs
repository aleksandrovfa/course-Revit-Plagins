...
namespace CreationModelPlagin
{
    ...
    public class CreationModel : IExternalCommand
    {
        ...
        private void AddWindow(Document doc, Level level1, Wall wall)
        {
            ...
            FamilyInstance familyInstance =  doc.Create.NewFamilyInstance(point, windowType, wall, level1, StructuralType.NonStructural);

            double height  = UnitUtils.ConvertToInternalUnits(1000, UnitTypeId.Millimeters);
            familyInstance.get_Parameter(BuiltInParameter.INSTANCE_SILL_HEIGHT_PARAM).Set(height);
